        ...
        <script id="contactTemplate" type="text/html">
            <li class="ui-widget-content ui-corner-all">
                ...
                <p>${ Address }, ${ City } ${ State } ${ Zip }<br />
                    ...
                    <a href="${ Self }" target='_blank'>View as Xml</a><br />
                ...
                <ItemTemplate>
                    <li>
                        ...
                        <p><%#DataBinder.Eval(Container.DataItem, "Address")%>, <%#DataBinder.Eval(Container.DataItem, "City")%> <%#DataBinder.Eval(Container.DataItem, "State")%> <%#DataBinder.Eval(Container.DataItem, "Zip")%><br />
                            ...
                            <a href="http://twitter.com/<%#DataBinder.Eval(Container.DataItem, "Twitter")%>">@<%#DataBinder.Eval(Container.DataItem, "Twitter")%></a><br />
                            <a href="<%#DataBinder.Eval(Container.DataItem, "Self")%>" target='_blank'>View as Xml</a><br />
                         <p><a href="<%#DataBinder.Eval(Container.DataItem, "Self")%>" class="removeContact">Remove</a><br /></p>
                        </p>
                    </li>
                </ItemTemplate>
            </asp:Repeater>
