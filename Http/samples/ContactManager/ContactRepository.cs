...
namespace ContactManager
{
    ...
    public class ContactRepository : IContactRepository
    {
        ...
        static ContactRepository()
        {
            ...
            contacts.Add(new Contact { ContactId = 2, Name = "Yavor Georgiev", Address = "1 Microsoft Way", City = "Redmond", State = "Washington", Zip = "98112", Email = "digthepony@microsoft.com", Twitter = "gblock" });
            nextContactID = 3;
        }
