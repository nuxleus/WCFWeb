...
namespace JsonValueBasic
{
    ...
    public static class Program
    {
        public static void Main()
        {
            ...
            Console.WriteLine("Get a value from inside a JSON string");
            
            Guid id = ja[0]["ID"].ReadAs<Guid>();
            float orderAmount = ja[0]["OrderAmount"].ReadAs<float>();
            Console.WriteLine("{0}, {1}" + Environment.NewLine, id, orderAmount);
            ...
            Console.WriteLine("Get a value from a string, but encounter wrong format in the string");
